...
public class Organization extends Annotation {
  ...
  */  
  ...
  public String getCanonical() {
    if (Organization_Type.featOkTst && ((Organization_Type)jcasType).casFeat_canonical == null)
      jcasType.jcas.throwFeatMissing("canonical", "test.Organization");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Organization_Type)jcasType).casFeatCode_canonical);}
  ...
  public void setCanonical(String v) {
    if (Organization_Type.featOkTst && ((Organization_Type)jcasType).casFeat_canonical == null)
      jcasType.jcas.throwFeatMissing("canonical", "test.Organization");
    jcasType.ll_cas.ll_setStringValue(addr, ((Organization_Type)jcasType).casFeatCode_canonical, v);}    
  }
